...
const Products = () => {
    ...
    <>
        ...
        <div className="">
        <input className={`ml-64 p-4 border-2 border-slate-200 bg-none rounded-full w-96 h-10 
        ...
        <div className={`bg-none ml-64 px-5 py-6 ${darkMode ? "dark:bg-gray-800 text-white" : ""}`}>
        <div className={`mb-6 flex justify-between ${darkMode ? "dark bg-gray-800" : ""}`}>
            ...
            {filteredProducts.map((product) => (
                <div key={product.id} className={`h-80 p-5 bg-white rounded-xl shadow-md ${darkMode ? "dark bg-gray-800" : ""}`}>
